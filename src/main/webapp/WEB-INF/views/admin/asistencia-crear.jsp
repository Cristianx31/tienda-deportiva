...
<head>
  <meta charset="UTF-8">
  <title>Crear Asistencia - DeportesX</title>
  ...
  <div class="container my-5">
    <div class="card shadow-lg">
      <div class="card-header text-center">
        <h3><i class="bi bi-calendar-plus"></i> Registrar Asistencia</h3>
      </div>
      <form class="p-4" action="${pageContext.request.contextPath}/admin/asistencia-crear" method="post">
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="time" class="form-control" id="horaIngresoAsistencia" name="horaIngreso" required>
        </div>
        <div class="mb-3">
          <label for="horaSalidaAsistencia" class="form-label">Hora Salida</label>
          <input type="time" class="form-control" id="horaSalidaAsistencia" name="horaSalida">
        </div>
