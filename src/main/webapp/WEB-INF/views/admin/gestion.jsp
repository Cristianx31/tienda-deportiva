              ...
              <tbody>
                <c:forEach var="venta" items="${ventas}">
                  ...
                  <td>
                      ...
                      <c:choose>
                        <c:when test="${venta.estado == 'Anulado'}">
                          <button class="btn btn-outline-secondary btn-sm" disabled><i class="bi bi-x-circle"></i> Anulada</button>
                        </c:when>
                        <c:otherwise>
                          <a href="${pageContext.request.contextPath}/admin/venta-anular/${venta.idVenta}" 
                             class="btn btn-outline-danger btn-sm" 
                             onclick="return confirm('¿Estás seguro de anular esta venta? Se devolverá el stock de los productos.');">
                ...
                <c:forEach var="empleado" items="${empleados}">
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="${pageContext.request.contextPath}/admin/empleado-eliminar/${empleado.id_usuario}" class="btn btn-outline-danger btn-sm" onclick="return confirm('¿Seguro que deseas eliminar este empleado?');">
                        <i class="bi bi-trash"></i> Eliminar
                      </a>
                    </td>
                  </tr>
