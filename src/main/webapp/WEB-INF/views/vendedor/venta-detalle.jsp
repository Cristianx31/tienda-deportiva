        ...
        <c:choose>
          ...
          <c:otherwise>
            ...
            <div id="js-content">
              ...
              <div class="text-end fs-5 fw-bold">
                Total: <span id="sale-total" class="text-primary">S/ 0.00</span>
              </div>
            </div>
            <script src="${pageContext.request.contextPath}/assets/js/cart.js"></script>
            <script>
              (function(){
                var data = sessionStorage.getItem('lastSale');
                ...
                var sale = {};
                try{ sale = JSON.parse(data) || {}; }catch(e){ sale = {}; }
                ...
                document.getElementById('sale-date').textContent = sale.date || '-';
                document.getElementById('client-name').textContent = sale.client || '-';
                document.getElementById('client-dni').textContent = sale.dni || '-';
